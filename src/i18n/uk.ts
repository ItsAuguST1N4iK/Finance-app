...
export const uk: Translations = {
  ...
  dashNoTxHint: 'Підключіть рахунки у Налаштуваннях',
  ...
  txNoResultsHint: 'Змініть фільтри або імпортуйте дані',
  txFilters: 'Фільтри',
  ...
  analyticsNoDataHint: 'Оберіть інший період або імпортуйте транзакції',
  ...
  settingsTabBar: 'Нижня панель',
  settingsTabLabels: 'Підписи табів',
  settingsTabLabelsHint: 'Показати назви під іконками навігації',
  ...
  settingsBiometric: 'Безпека',
  settingsBiometricLock: 'Вхід за відбитком',
  settingsBiometricHint: 'Блокувати додаток при відкритті та після згортання',
  biometricTitle: 'Розблокуйте додаток',
  biometricSubtitle: 'Підтвердіть особу відбитком пальця або Face ID',
  biometricPrompt: 'Підтвердіть вхід у Finance Control',
  biometricEnablePrompt: 'Підтвердіть, щоб увімкнути блокування',
  biometricUnlock: 'Розблокувати',
  biometricFailed: 'Не вдалося підтвердити. Спробуйте ще раз.',
  ...
  plannerEmptyTitle: 'Планових записів немає',
  plannerEmptyHint: 'Додайте очікувані надходження або витрати',
  ...
  settingsAutoRules: 'Автоправила категорій',
  settingsAutoRulesHint: 'Правила, які додаток створює автоматично (скрапери, IBKR). Можна редагувати й видаляти.',
  settingsAutoCategories: 'Автокатегорії',
  settingsAutoCategoriesHint: 'Вбудовані категорії додатку. Можна змінити назву, колір, вплив або сховати.',
  settingsNoAutoCategories: 'Немає автокатегорій',
  ...
  settingsTransparencyHint: '0% — непрозоро, 100% — максимальна прозорість карток і панелей',
  settingsTransparencyPreview: 'Приклад панелі',
  settingsTransparencyPreviewHint: 'Так виглядатимуть картки та секції',
  themeLabelDark: 'Темно-синя',
  themeLabelCursor: 'Темно-сіра',
  themeLabelOled: 'OLED чорна',
  themeLabelLight: 'Світла',
