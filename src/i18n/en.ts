...
export const en: Translations = {
  ...
  dashNoTxHint: 'Connect accounts in Settings',
  ...
  txNoResultsHint: 'Change filters or import data',
  txFilters: 'Filters',
  ...
  analyticsNoDataHint: 'Pick another period or import transactions',
  ...
  settingsTabBar: 'Bottom bar',
  settingsTabLabels: 'Tab labels',
  settingsTabLabelsHint: 'Show names under navigation icons',
  ...
  settingsBiometric: 'Security',
  settingsBiometricLock: 'Fingerprint lock',
  settingsBiometricHint: 'Lock the app on launch and when returning from background',
  biometricTitle: 'Unlock the app',
  biometricSubtitle: 'Confirm with fingerprint or Face ID',
  biometricPrompt: 'Unlock Finance Control',
  biometricEnablePrompt: 'Confirm to enable app lock',
  ...
  plannerEmptyTitle: 'No planned entries',
  plannerEmptyHint: 'Add expected income or expenses',
  plannerPaid: 'Paid',
  ...
  settingsAutoRules: 'Auto category rules',
  settingsAutoRulesHint: 'Rules the app creates automatically (scrapers, IBKR). You can edit and delete them.',
  settingsAutoCategories: 'Auto categories',
  settingsAutoCategoriesHint: 'Built-in app categories. You can rename, recolor, change impact, or hide them.',
  settingsNoAutoCategories: 'No auto categories',
  ...
  settingsTransparencyHint: '0% — opaque, 100% — maximum transparency of cards and panels',
  settingsTransparencyPreview: 'Panel preview',
  settingsTransparencyPreviewHint: 'How cards and sections will look',
  themeLabelDark: 'Dark Blue',
  themeLabelCursor: 'Dark Grey',
  themeLabelOled: 'OLED Black',
